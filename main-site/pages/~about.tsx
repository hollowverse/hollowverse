            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-5 text-lg text-neutral-600">
                <p>
                  ...
                  you know about celebrities&apos; religions and political
                  views, regardless of what those might be. We want to be a
                  place of entertainment and discovery, and we also want to be
                  as informative and unbiased as possible.
                </p>
                ...
                <p>
                  Facts are to Hollowverse what Tweets are to Twitter.
                  Hollowverse Facts are simply sayings or actions that
                  celebrities did publicly.
                </p>

                <p>
                  You can submit a Fact or write a reply to one. Our Fact
                  guidelines are open for everyone to see, our process is
                  transparent. We accept Facts for any celebrity of any
                  political or religious ideology and our own ideologies have no
                  influence on our decision to accept or reject a Fact.
                </p>

                <p>
                  Once a Fact is accepted, it receives Issues and Tags. Issues
                  are the discussion subjects related to the Fact, and the Tag
                  is a way for users to easily understand the position of that
                  celebrity when it comes to the Issue in question.
                </p>

                <p>
                  For example, if a celebrity claims to confess to a priest
                  every week, we would assign the Issue:{' '}
                ...
                <p>
                  ...
                  where you can comment on any Fact. This is our way to
                  stimulate conversations about the Issues and Tags applied to
                  celebrities. It&apos;s a place for you to learn with the
                  community, but more importantly, a place to argue and question
                  the Issues and Tags applied to the Fact. After all, religion
                  and politics are complex subjects close to most people&apos;s
                  hearts, and we want to make sure Hollowverse represents in as
                  objective and clear a way as possible what the beliefs of
                  celebrities are.
                </p>
