      ...
      >
        ...
        >
          {(isHomepage || showSearch) && (
            <div className="md:flex items-center justify-between rounded-md pl-2 border border-lg-1 w-full md:w-400 h-auto flex">
              <Image
                layout="intrinsic"
                width={35}
                height={35}
          ...
          {!isHomepage && !showSearch && (
            <button
              ...
              className="items-center justify-center md:hidden hover:bg-slate-100 active:bgd-slate-200 transition-colors rounded-full h-10 w-10 flex"
            >
              <Image
                layout="intrinsic"
                width={36}
