...
export const Contribute = () => {
  ...
  return (
    <>
      ...
      <div className="mx-5">
        <div className="mx-auto flex max-w-4xl flex-col gap-5 py-5">
          <h1 className="text-2xl font-bold">Add to {name}&apos;s page</h1>

          <main className="flex flex-col gap-5">
            <div className="flex flex-col gap-2.5 bg-gray-100 p-5">
              <p className="leading-normal">
                To show our appreciation for your contributions, we are offering
                a $25 Amazon® gift card to each of the{' '}
            ...
            <div className="border-l-8 border-blue-300 bg-blue-50 p-2.5">
              ...
              <p className="leading-normal">
                There&apos;s a button at the bottom that will open the
                Hollowverse discussion board. If this is your first time, you
            ...
            <div className="border-l-8 border-blue-300 bg-blue-50 p-2.5">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <p className="leading-normal">
                  The text editor will be pre-filled with some information to
                  give you a bit more help with the process. When you&apos;re
                  finished, submit the post.
                </p>
              </div>
            </div>
            ...
            <div className="border-l-8 border-blue-300 bg-blue-50 p-2.5">
              ...
              <p className="leading-rela leading-normal">
            ...
            <div className="border-l-8 border-blue-300 bg-blue-50 p-2.5">
              ...
              <p className="leading-rela leading-normal">
                At the end of each month, we tally up contributor posts across
                all pages. The 3 contributors with the most posts receive a $25
          ...
          <section>
            <a
              href={href}
              className="rounded-lg border-2 border-white bg-gray-100 py-2 px-3.5 transition hover:bg-gray-200 focus:border-blue-300"
              onClick={(e) => {
                e.preventDefault();
