  ...
  **What is the source for this information?**`;
  ...
  return (
    <Container className={s.HowToContribute} maxWidth="md">
      {(isLoading && (
        <Backdrop className={s.backdrop} open>
        ...
        <>
          ...
          <Typography>
            ...
            people read Hollowverse everyday. I&apos;m sure they&apos;ll
          ...
          <Typography>
            ...
            discussion board. If you&apos;re a first-time contributor, you will
            be asked to sign-up because you need to have a user account to
            contribute.
          </Typography>
          ...
          <Typography>
            After you complete the sign-up and verify your email address, the
            text editor will be displayed. That&apos;s where you can add
            information. If the text editor didn&apos;t open, go back to{' '}
            <a href={`/${slug}`}>{name}&apos;s page</a> and click on the
            &quot;Add info&quot; button again.
          </Typography>

          <Typography>
            The text editor will be pre-filled with some information to give you
            a bit more help with the process. Go ahead and add your stuff then
            submit the post.
          </Typography>
          ...
          <Typography>
            After you submit the post, one of our team members will validate
            that everything looks good and we will publish the information on{' '}
            {name}&apos;s page. And we will give you credit for the
            contribution!
          </Typography>
          ...
          <div className={s.openDiscussionBoardButton}>
            <Button variant="outlined" endIcon={<EditIcon />} href={href}>
